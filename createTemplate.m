...
%createTemplate-Creates the .mat file of the given character templates
%Letter
...
%*-*-*-*-*-*-*-*-*-*-*-
%Other Characters
dash=imread('letters_numbers\-.bmp');
dot=imread('letters_numbers\dot.bmp');
...
character=[letter number others];
templates=mat2cell(character,42,[24 24 24 24 24 24 24 ...
    24 24 24 24 24 24 24 ...
    24 24 24 24 24 24 24 ...
    24 24 24 24 24 24 24 ...
    24 24 24 24 24 24 24 24 24 24]);
imshow(templates{1,1});
